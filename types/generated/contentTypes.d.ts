...
export interface ApiArticleCategoryArticleCategory
  ...
  attributes: {
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#FFD23F'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiClimbingServiceClimbingService
  extends Struct.CollectionTypeSchema {
  collectionName: 'climbing_services';
  info: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::climbing-service.climbing-service'
    >;
...
export interface ApiGalleryImageGalleryImage
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['climbing', 'boulder', 'training', 'events']
    > &
      Schema.Attribute.DefaultTo<'climbing'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files'> &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    icon: Schema.Attribute.Enumeration<
      ['beginner', 'pro-training', 'kids', 'groups', 'shop', 'events']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
...
export interface ApiSingleNewsSingleNews extends Struct.CollectionTypeSchema {
  collectionName: 'plural_news';
  info: {
    displayName: 'News';
    pluralName: 'plural-news';
  ...
  attributes: {
    ...
    featuredImageCredit: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::climbing-service.climbing-service': ApiClimbingServiceClimbingService;
